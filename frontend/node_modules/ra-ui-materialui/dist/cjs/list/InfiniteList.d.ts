...
export declare const InfiniteList: {
    <RecordType extends RaRecord = any>({ debounce, disableAuthentication, disableSyncWithLocation, exporter, filter, filterDefaultValues, pagination, perPage, queryOptions, resource, sort, storeKey, ...rest }: InfiniteListProps<RecordType>): ReactElement;
    propTypes: {
